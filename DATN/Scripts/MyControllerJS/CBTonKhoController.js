var app = angular.module('CBTonKhoApp', []);

app.controller('CBTonKhoController', function ($scope, $http) {
    ...
    ///////////////
    //$http.get('/api/CBTonKhoAPI/GetTonKho')
    //    .then(function (response) {
    ...
    $scope.export = function () {
        $http({
            method: 'GET',
            url: '/api/CBTonKhoAPI/ExportTonKho',
    ...
    $scope.SEARCH = function () {
        ...
        $scope.search.ma_vt_list = selectedVTCodes;
        // Gọi API tìm kiếm
        $http.get('/api/CBTonKhoAPI/SearchTonKho', {
            params: {
