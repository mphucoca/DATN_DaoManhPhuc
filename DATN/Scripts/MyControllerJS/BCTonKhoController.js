var app = angular.module('BCTonKhoApp', []);

app.controller('BCTonKhoController', function ($scope, $http) {
    ...
    ///////////////
    //$http.get('/api/BCTonKhoAPI/GetTonKho')
    ...
    $scope.export = function () {
        $http({
            method: 'GET',
            url: '/api/BCTonKhoAPI/ExportTonKho',
    ...
    $scope.SEARCH = function () {
        ...
        $scope.search.ma_vt_list = selectedVTCodes;
        // Gọi API tìm kiếm
        $http.get('/api/BCTonKhoAPI/SearchTonKho', {
            params: {
                ma_vt_list: $scope.search.ma_vt_list  ,// Chuỗi mã vật tư
                ma_kho_list: $scope.search.ma_kho_list  // Chuỗi mã kho
            }
        }).then(function (response) {
            $scope.ds_main = response.data;  // Cập nhật danh sách tồn kho
        }).catch(function (error) {
